...
Route::post('/otp/send', [TicketController::class, 'sendOTP'])->name('otp.send');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/scanner', [CheckInController::class, 'index'])->name('checkin.index');
    Route::post('/scanner/validate', [CheckInController::class, 'validateTicket'])->name('checkin.validate');
